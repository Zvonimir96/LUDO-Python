...
def draw_path_lines(screen):
    first_field_position = path_fields[0].get_position()
    ...
    for field in path_fields[1:]:
        field_position = field.get_position()
        pygame.draw.line(screen, white_color, field_position, last_field_position, path_line_width)
        last_field_position = field_position

    # Connect last and first file
    pygame.draw.line(screen, white_color, last_field_position, first_field_position, path_line_width)
